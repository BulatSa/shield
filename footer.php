...
<div class="modals-sec">
	...
	<div id="modal-callback" class="modal">
		<p class="h4 modal__title"><span class="blue">Обратный звонок</p>
		<form class="ajax-form">
...
<script>
	var onloadCallback = function() {
		var captha_placeholders = document.querySelectorAll('.g-recaptcha');
		for (var i = 0; i < captha_placeholders.length; i++) {
			grecaptcha.render(captha_placeholders[i], {
