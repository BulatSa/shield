...
<section class="big-head-sec" style="background-image: url('../img/tariffs/head-bg-2.jpg')">
	<div class="container">
		<div class="big-head">
			<div class="big-head__info">
				<h1>Тариф Оптимальный</h1>
				<p>Вы можете воспользоваться этим тарифом, если полностью хотите контролировать процесс, но не планируете вникать в его детали. Все это за вас сделает команда наших опытных юристов. Пакет подходит для суммы ущерба от 500 000 рублей.</p>
			...
			<div class="big-head__bottom">
				<div class="big-head__lock">
					<img src="/img/tariffs/lock.svg" alt="1">
					<span>Если мы не сможем запустить процесс, вернем предоплату полностью в&nbsp;течение 24 часов.</span>
				</div>
			</div>
		</div>
	</div>
...
<section class="s-tariff-content">
	<div class="container">
		<div class="row">

			<div class="grid-6 grid-12_m">
				<div class="h1">В пакет входит</div>
				<ul class="checked-list text-big">
					<li>Полное сопровождение дела</li>
					<li>Персональный юрист</li>
					<li>Персональный менеджер</li>
					<li>Безлимитные консультации специалистов до завершения дела</li>
				</ul>
			</div>

			<div class="grid-6 grid-12_m">
				<div class="ai-block">
					<div class="h3">Все включено</div>
					<ul class="checked-list checked-list--black">
						<li>Работа по договору</li>
						<li>Круглосуточная консультация с персональным менеджером</li>
						<li>Издержки на составление и&nbsp;отправку документов в&nbsp;случае первичного отказа</li>
						<li>Возврат денег в&nbsp;течение 10&nbsp;дней, если не&nbsp;устроила работа команды</li>
					</ul>
				</div>
				<div class="dogovor-block">
					<img src="/img/tariffs/dogovor.png" alt="Договор">
					<a href="#" class="link-icon"><i class="icon-download"></i><span>Подписать электронный договор</span></a>
				</div>
			</div>
